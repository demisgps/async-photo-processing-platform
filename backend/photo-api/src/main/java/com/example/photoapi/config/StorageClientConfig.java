...
public class StorageClientConfig {
    ...
    StorageOptions.Builder configure(StorageOptions.Builder builder, StorageProperties properties) {
        RetrySettings retry = RetrySettings.newBuilder()
                ...
                .setMaxRetryDelay(duration(properties.maxBackoff()))
                .setJittered(true)
                .setInitialRpcTimeout(duration(properties.rpcTimeout()))
                .setRpcTimeoutMultiplier(1.0)
                .setMaxRpcTimeout(duration(properties.rpcTimeout()))
                .setTotalTimeout(duration(properties.totalTimeout()))
                .build();
