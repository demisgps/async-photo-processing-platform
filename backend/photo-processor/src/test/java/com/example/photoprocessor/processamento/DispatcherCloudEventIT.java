...
class DispatcherCloudEventIT {
    @Test void dispatcherCompatibleStructuredDataReachesFunctionWithoutBusinessTranslation() throws Exception {
        ...
        var function=new PhotoProcessorFunction(new ProcessorProperties(URI.create("http://localhost"),"storage-p","fotos-usuarios-original","processed","p","t",25_000_000),service);
