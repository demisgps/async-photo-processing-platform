...
class DispatcherCloudEventIT {
    @Test void dispatcherCompatibleStructuredDataReachesFunctionWithoutBusinessTranslation() throws Exception {
        ...
        var function=new PhotoProcessorFunction(new ProcessorProperties(URI.create("http://localhost"),"project","fotos-usuarios-original","processed","t",25_000_000),service);
